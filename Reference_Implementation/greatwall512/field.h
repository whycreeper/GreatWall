...
#define GF_transposed_matmul_add GREATWALL_NAMESPACE(GF_transposed_matmul_add)
void GF_transposed_matmul_add(GF c, const GF a, const GF b[PYLON_NUM_BITS_FIELD]);

#define GF_mul_s GREATWALL_NAMESPACE(GF_mul_s)
void GF_mul_s(GF c, const GF a, const GF b);
#define GF_mul_add_s GREATWALL_NAMESPACE(GF_mul_add_s)
void GF_mul_add_s(GF c, const GF a, const GF b);
#define GF_sqr_s GREATWALL_NAMESPACE(GF_sqr_s)
