...
#define GREATWALL_NAMESPACE(s)          GREATWALL512_N16_ref_##s

#define SECURITY_BITS               512                  // security parameter
...
#define GREATWALL_T                     129                   // number of parallel repetitions (Tau)
#define GREATWALL_N                     16                   // number of MPC parties (N)
#define GREATWALL_LOGN                  4                    // log_2(N)
