...
#define GREATWALL_NAMESPACE(s)          GREATWALL384_N16_ref_##s

#define SECURITY_BITS               384                  // security parameter
...
#define GREATWALL_T                     97                   // number of parallel repetitions (Tau)
