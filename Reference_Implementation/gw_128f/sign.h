...
typedef struct proof_t
{
  ...
  uint8_t delta_ts_bytes[AIMER_L - 1][AIM2_NUM_BYTES_FIELD];
  uint8_t delta_c_bytes[AIM2_NUM_BYTES_FIELD];
  uint8_t missing_alpha02_share_bytes[AIM2_NUM_BYTES_FIELD];
  uint8_t missing_alpha1_share_bytes[AIM2_NUM_BYTES_FIELD];
} proof_t;
