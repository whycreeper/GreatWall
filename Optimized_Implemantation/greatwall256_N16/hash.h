...
#include "common/keccak4x/KeccakP-1600-times4-SnP.h"
#include <stddef.h>
#include <stdint.h>
...
#define hash_init_x4 GREATWALL_NAMESPACE(hash_init_x4)
void hash_init_x4(hash_instance_x4 *ctx);
#define hash_init_prefix_x4 GREATWALL_NAMESPACE(hash_init_prefix_x4)
void hash_init_prefix_x4(hash_instance_x4 *ctx, uint8_t prefix);
#define hash_update_x4 GREATWALL_NAMESPACE(hash_update_x4)
void hash_update_x4(hash_instance_x4 *ctx, const uint8_t **data,
                    size_t data_len);
#define hash_update_x4_1 GREATWALL_NAMESPACE(hash_update_x4_1)
void hash_update_x4_1(hash_instance_x4 *ctx, const uint8_t *data,
                      size_t data_len);
#define hash_final_x4 GREATWALL_NAMESPACE(hash_final_x4)
void hash_final_x4(hash_instance_x4 *ctx);
#define hash_squeeze_x4 GREATWALL_NAMESPACE(hash_squeeze_x4)
