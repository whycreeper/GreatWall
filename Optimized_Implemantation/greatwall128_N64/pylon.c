...
void GF_exp_invmer_e_3(GF out, const GF in)
{
  ...
  GF_mul(table_4_4, t1, table_4);

  GF_sqr(t1, table_4_4);
  for(int i = 1 ; i < 6; i++){
    GF_sqr(t1, t1);
  }
  GF_mul(table_4_4, t1, table_4_4);
  ...
  GF_mul(table_4_16, t1, table_4_4);

  GF_sqr(t1, table_4_16);
  for(int i = 1 ; i < 24; i++){
    GF_sqr(t1, t1);
  }
  GF_mul(table_4_16, t1, table_4_16);
