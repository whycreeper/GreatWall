...
void GF_exp_invmer_e_3(GF out, const GF in)
{
  ...
  GF_mul(table_6_5, t1, table_6);

  GF_sqr(t1, table_6_5);
  for(int i = 1 ; i < 6; i++){
    GF_sqr(t1, t1);
  }
  GF_mul(table_6_5, t1, table_6_5);
  ...
  GF_mul(table_6_5_16, t1, table_6_5);

  GF_sqr(t1, table_6_5_16);
  for(int i = 1 ; i < 30; i++){
    GF_sqr(t1, t1);
  }
  GF_mul(table_6_5_16, t1, table_6_5_16);
  ...
  GF_mul(t1, t1, table_6_5);

  GF_sqr(t1, t1);
  GF_mul(out, t1, in);
}
void GF_prints(const GF x)
{
