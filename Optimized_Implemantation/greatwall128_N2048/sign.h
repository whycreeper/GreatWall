...
{
  GF pt_share[GREATWALL_N];
  GF Delta_share[GREATWALL_N];
  GF x_shares[GREATWALL_L][GREATWALL_N];
  GF z_shares[GREATWALL_L][GREATWALL_N];
} mult_chk_N_t;
...
#define pylon_mpc_N GREATWALL_NAMESPACE(pylon_mpc_N)
void pylon_mpc_N(mult_chk_N_t *mult_chk, const GF ct_GF);

#define commit_and_expand_tape_x4 GREATWALL_NAMESPACE(commit_and_expand_tape_x4)
void commit_and_expand_tape_x4(tape_t *tape, uint8_t *commit,
