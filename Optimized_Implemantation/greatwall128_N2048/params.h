...
#define GREATWALL_NAMESPACE(s)          GREATWALL128_N2048_avx2_##s
...
#define GREATWALL_T                     13                   // number of parallel repetitions (Tau)
#define GREATWALL_N                     2048                   // number of MPC parties (N)
#define GREATWALL_LOGN                  11                    // log_2(N)
